...
<body>
    ...
    <main>
        <section class="privacy-policy">
            ...
            <p>We will retain Your Personal Data for the duration of the patient's treatment. After the treatment ends, typically within a 12-week period, the data will be deleted unless legally required for a longer retention period.</p>
