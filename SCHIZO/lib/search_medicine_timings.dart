...
import 'package:schizo/common.dart%20';
import 'Add_medicine.dart';

class SearchAddMedicine extends StatefulWidget {
  @override
  _SearchAddMedicineState createState() => _SearchAddMedicineState();
}

class _SearchAddMedicineState extends State<SearchAddMedicine> {
  ...
  Future<void> fetchPatientIds() async {
    try {
      final response = await http.post(
        Uri.parse(searchmed), // Replace with your PHP script URL
      );
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MedicineData(patientId: _selectedPatientId),
                          ),
                        );
                      },
                      child: ListTile(
